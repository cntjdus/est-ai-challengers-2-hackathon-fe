...
export default function OnboardingHeader({ onBack }) {
  return (
    <header className="z-10 grid h-app-header shrink-0 grid-cols-[36px_minmax(0,1fr)_36px] items-center border-b border-[#f1f5f9] bg-[#f8fafc]/90 px-5 backdrop-blur-[6px]">
