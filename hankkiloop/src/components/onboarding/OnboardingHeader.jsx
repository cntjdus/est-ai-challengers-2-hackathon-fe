...
export default function OnboardingHeader({ onBack }) {
  return (
    <header className="z-10 grid h-app-header shrink-0 grid-cols-[36px_minmax(0,1fr)_80px] items-center border-b border-[#f1f5f9] bg-[#f8fafc]/90 px-5 backdrop-blur-[6px]">
      ...
      <div className="flex items-center gap-1"><NotificationButton /><span aria-hidden="true" className="size-10 shrink-0" /></div>
    </header>
  )
}
