...
export default function AvoidIngredientsSection({ ingredientInput, onInputChange, onInputKeyDown, excludedIngredients, onRemove, title = '피하고 싶은 재료', description = '선호하지 않는 재료를 입력하고 Enter를 눌러 등록해주세요.', sectionId = 'avoid-heading', inputLabel = '제외 재료 검색' }) {
  return (
